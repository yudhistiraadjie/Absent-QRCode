...
<body>
    ...
    <div class="konten">
        ...
        <div class="card text-center">
          <div class="card-body">
          <h3 class="card-title font">SELAMAT DATANG<br> <?= $this->session->userdata('nama'); ?> (Sebagai ADMIN)</h3>
          <h5 class="card-text font">Silahkan Absen Disini</h5>
          <br>
          <a href="<?= base_url('absen/qrCode')?>" id="btn-masuk" class="btn btn-primary">Tampilkan QR Code</a>
        </div>
        </center>
    </div>
    <!-- Konten end -->
