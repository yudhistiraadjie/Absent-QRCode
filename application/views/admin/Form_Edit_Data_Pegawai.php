...
<!-- Form Input Data -->
<form class="card" method="post" action="<?= base_url('admin/editSave')?>">
...
<hr>
  <div class="form-group row">
    ...
    <div class="col-sm-8">
      <input type="text" class="form-control" placeholder="NIK" name="nik" value="<?= $tampil->nik?>" readonly>
    </div>
  </div>
  <div class="form-group row">
    <label class="col-sm-2 col-form-label pl-5">Nama</label>
    <div class="col-sm-8">
      <input type="text" class="form-control" placeholder="Nama" name="nama" value="<?= $tampil->nama?>">
    </div>
  </div>
  <div class="form-group row">
    <label class="col-sm-2 col-form-label pl-5">Tanggal Lahir</label>
    <div class="col-sm-8">
      <input type="date" class="form-control" name="tgl" value="<?= $tampil->ttl?>">
    </div>
  </div>
  <div class="form-group row">
    ...
    <div class="col-sm-8">
      ...
      <?php if($tampil->jenis_kelamin == "Pria"){
        $selected = ['selected',''];
      } else if ($tampil->jenis_kelamin == "Wanita"){
        $selected =['','selected'];
      }
      ?>
        <option value="Pria" <?= $selected[0];?>>Pria</option>
        <option value="Wanita" <?= $selected[1];?>>Wanita</option>
      </select>
    </div>
  </div>
  <div class="form-group row">
    ...
    <div class="col-sm-8">
      <input type="text" class="form-control" placeholder="Alamat" name="alamat" value="<?= $tampil->alamat?>">
    </div>
  </div>
  <div class="form-group row">
    <label class="col-sm-2 col-form-label pl-5">No. Telepon</label>
    <div class="col-sm-8">
      <input type="number" class="form-control" placeholder="No. Telepon" name="no_tlp" value="<?= $tampil->no_tlp?>">
    </div>
  </div>
  <div class="form-group row">
    <label class="col-sm-2 col-form-label pl-5">Username</label>
    <div class="col-sm-8">
      <input type="text" class="form-control" placeholder="Username" name="username" value="<?= $tampil->username?>">
    </div>
  </div>
  <div class="form-group row">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-8">
      ...
      <?php if($tampil->kd_jabatan == "1"){
        $selected = ['selected',''];
      } else if ($tampil->jenis_kelamin == "2"){
        $selected =['','selected'];
      }
      ?>
        <option value="1" <?= $selected[0];?>>Admin</option>
        <option value="2"<?= $selected[1];?>>Pegawai</option>
      </select>
    </div>
  </div>
  <div class="form-group row ">
